...
export default function Login() {
  ...
  return (
    <>
      <PageMeta
        title="Đăng nhập trang quản lý Apolo Lawvers"
        description="Hãy vào và tham quan "
      />
      <Logo />
      <Row className="py-[100px] w-1240">
        <Col md={6}>
          <div className="">
            ...
            <div className="w-[439.96px] pt-4 text-center text-[#002740] text-[32px] font-bold font-space-grotesk leading-10">
        ...
        <Col md={6}>
          <div className="w-[567px] h-[440px] px-16 py-8 rounded-2xl flex-col justify-start items-center gap-10 inline-flex">
            <div className="text-center text-[#002740] text-[32px] font-bold font-space-grotesk leading-10">
              Đăng nhập vào Apolo Lawyers
            </div>
            <form onSubmit={handleSubmit}>
              <div className="self-stretch h-[296px] flex-col justify-center items-end gap-6 flex">
                <div className="self-stretch h-[74px] flex-col justify-start items-start gap-1.5 flex">
                  <div className="self-stretch h-[74px] flex-col justify-start items-start gap-1.5 flex">
                    <div className="text-[#344054] text-sm font-semibold font-open-sans leading-tight">
                      Email
                    </div>
                    <input
                      type="email"
                ...
                <div className="rounded-lg justify-center items-center gap-1.5 inline-flex cursor-pointer">
                  <div
                    className="text-[#1cb0ad] text-sm font-semibold font-open-sans leading-tight"
                    onClick={() => {
